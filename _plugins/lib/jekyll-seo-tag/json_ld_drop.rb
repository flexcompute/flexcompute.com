...
module Jekyll
  class SeoTag
    class JSONLDDrop < Jekyll::Drops::Drop
      ...
      SEO_VALID_ENTITY_TYPES = %w(BlogPosting CreativeWork).freeze
      SEO_VALID_AUTHOR_TYPES = %w(Organization Person).freeze
      private_constant :SEO_VALID_ENTITY_TYPES, :SEO_VALID_AUTHOR_TYPES
      ...
      def author
        ...
        return if author_type && !SEO_VALID_AUTHOR_TYPES.include?(author_type)
      ...
      def main_entity
        return unless SEO_VALID_ENTITY_TYPES.include?(type)
